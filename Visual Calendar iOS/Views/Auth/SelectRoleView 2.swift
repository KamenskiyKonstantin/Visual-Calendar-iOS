        ...
        NavigationStack {
            VStack(spacing: 40) {
                ...
                Button(action: {
                    ...
                    Text("SelectRole.Selector.Child.Button.Title".localized)
                        .font(.title)
                ...
                Button(action: {
                    ...
                    Text("SeletRole.Selector.Adult.Button.Title".localized)
                        .font(.title)
                        .frame(width: 300, height: 80)
...
struct AdultVerificationModal<ViewModel: SelectRoleViewModelProtocol>: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Button("SelectRole.Verification.Submit.Button.Title".localized) {
